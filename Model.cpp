...
Model::Model(const char* file, unsigned int instancing, std::vector<glm::mat4> instanceMatrix)
{
	...
	// Set instancing and instance matrix
...
void Model::Draw(Shader& shader, Camera& camera, glm::mat4 userModel, glm::vec3 translation, glm::quat rotation, glm::vec3 scale)
{
	// Go over all meshes and draw each one
	for (unsigned int i = 0; i < meshes.size(); i++)
	{
		meshes[i].Mesh::Draw(shader, camera, userModel * matricesMeshes[i], translation, rotation, scale);
	}
}
